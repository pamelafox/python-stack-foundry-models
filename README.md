...
| [lm15_request.py](examples/lm15_request.py) | Calling either OpenAI or Claude models using the typed, provider-neutral lm15 interface. |
| [lm15_router.py](examples/lm15_router.py) | Calling either OpenAI or Claude models through lm15's multi-provider router. |
